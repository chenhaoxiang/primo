...
/**
 * @author chenhx
 * @version OperationParameterReaderBuilder.java, v 0.1 2019-11-18 17:06 chenhx
 */
@Component
@Order(Ordered.HIGHEST_PRECEDENCE)
public class OperationParameterReaderExt implements OperationBuilderPlugin {
    private final ModelAttributeParameterExpander expander;
    private final EnumTypeDeterminer enumTypeDeterminer;

    @Autowired
    private DocumentationPluginsManagerExt pluginsManager;

    @Autowired
    public OperationParameterReaderExt(
