package wiki.primo.generator.mybatis.plus.springbootdemo.domain.resp;
 ...
 */
public class UrlRuleWebDriverConfigResp implements Serializable {
...
private static final long serialVersionUID = 1L;
	...
	public String toString() {
		final StringBuilder sb = new StringBuilder("UrlRuleWebDriverConfig{").append(super.toString());
