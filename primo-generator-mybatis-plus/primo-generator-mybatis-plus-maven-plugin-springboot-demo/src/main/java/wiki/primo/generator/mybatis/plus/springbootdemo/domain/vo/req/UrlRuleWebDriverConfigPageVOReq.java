 ...
 */
public class UrlRuleWebDriverConfigPageVOReq implements Serializable {
    private static final long serialVersionUID = -3324441151421460917L;
    /**
     * 查询条件
     */
    private UrlRuleWebDriverConfigQueryBo queryBo;
    /**
     * 当前页
     */
    ...
    public UrlRuleWebDriverConfigQueryBo getQueryBo() {
        return queryBo;
    }

    public void setQueryBo(UrlRuleWebDriverConfigQueryBo queryBo) {
